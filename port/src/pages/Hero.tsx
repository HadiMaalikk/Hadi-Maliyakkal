    ...
    <>
      ...
      */}
      ...
      <section className="relative min-h-screen flex items-center">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-center w-full">
          <div className="relative font-inter text-center md:text-center md:w-1/2">
            <div className="flex gap-2 justify-center mb-6 flex-wrap">
              <Bento
                to="/portfolio"
                className="py-10 aspect-square w-48 hover:shadow-[0_0_8px_rgba(255,255,255,0.8)] transition-all duration-500"
                title="Portfolio"
              ></Bento>
              <Bento
                to="/portfolio"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-center w-full">
          <div className="relative font-inter text-center md:text-center md:w-1/2">
            <h1 className="text-white text-2xl font-thin mt-[60px] mb-3">
              about <span className="font-semibold">me.</span>
            </h1>
            <p className="text-white leading-tight font-thin">
              Hello! I'm Hadi Maliyakkal, a passionate web developer with a
              knack for creating stunning and functional websites. With a strong
              ...
              in web development began with a curiosity for how websites work,
              which quickly turned into a full-blown passion. I love
              transforming ideas into reality through code and design. When I'm
              not coding, you can find me exploring the latest tech trends or
              indulging in my hobbies like photography and gaming. Let's connect
      ...
      <section className=" relative min-h-[700px] flex items-center">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-center w-full">
          <div className="relative font-inter text-center md:text-center md:w-1/2">
            <p className="text-white leading-tight font-thin text-lg">
